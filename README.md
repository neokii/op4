...
***SPAS***
----------
   - Make sure to install the correct panda firmware, needs reinstall after update and comes with EMS366 stock. https://github.com/Circuit-Pro/panda/blob/docs/README.md
